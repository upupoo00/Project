...
<%
    ...
    int linecount=cs.getCommoditcount();
    int pagecount=0;
    int start=0;
    ...
    if(pagenow!=null){
        ...
        if(Integer.parseInt(pagenow)<1) {
            list = cs.getCommoditFy(1);
        }else if(Integer.parseInt(pagenow)>pagecount){
            list = cs.getCommoditFy(pagecount);
        }else {
            list=cs.getCommoditFy(Integer.parseInt(pagenow));
        }
    }else {
        start=1;
        list=cs.getCommoditFy(1);
      ...
      <!--左侧导航栏-->
            ...
            <ul class="nav nav-pills nav-stacked" style="background-color: rgb(241, 240, 238);">
                ...
                <li style="border: 1px solid rgb(202, 202, 202);">
                    ...
                    <ul class="nav collapse" id="second-level-3" style="background-color: rgba(248, 255, 253, 0.952);">
                        ...
                        <a href="findCommoditBySort.do?sort=女装:(上衣)" style="position: relative;margin-left: 30px;font-size: 15px;"><input type="button" value="外套" id="女外套"></a>
                        ...
                        <a href="findCommoditBySort.do?sort=女装:(裙子)" style="position: relative;margin-left: 30px;font-size: 15px;"><input type="button" value="裙子" id="裙子"></a>
       ...
       <div class="center-right">
        ...
        <div class="center2-1">
           ...
           <!--价格-->
           <p style="font-size: 18px;text-align: center;position: absolute;top: 50px;left: 10px;">￥${commodit.price}元</p>
           </div>
            <form action="addCart.do" method="post" id="addCart">
            <div class="center2-1-3">
                <a href="addCartShopping.do?id=<%=commodit.getSid()+","+uid%>" style="font-size: 13px;color: rgb(136, 135, 135);">
                ...
                <div class="center3" style="border: 0px solid red;
                    ...
                    <ul class="pager">
                        <li class="previous" style="position: relative;
                                            ...
                                            margin-top: -15px;
                                            margin-left: 160px;">
                            <a href="shopping.jsp?pagenow=<%=start-1%>">&larr;上一页</a></li>
                        <li class="next" style="position: relative;
                                            float: right;
                                            margin-top: -15px;
                                            margin-right: 160px;">
                            <a href="shopping.jsp?pagenow=<%=start+1%>">下一页&rarr;</a></li>
                      </ul>
                </div>
       </div>
  </div>
